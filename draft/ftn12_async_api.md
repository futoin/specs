...
Sometimes, it's required to return a value after inner step are executed. It leads
to code like:
...
To optimize and make the code cleaner previously deprecated `successStep()` is
returned. Example:
